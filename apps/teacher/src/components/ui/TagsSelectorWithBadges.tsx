...
interface TagsSelectorWithBadgesProps {
...
export function TagsSelectorWithBadges({
  availableTags,
  selectedTags,
  onChange,
  onCreateTag,
          ...
          {selectedTags.map(tag => (
            ...
            >
              ...
              <button
                ...
                className="absolute -top-1 -right-1 h-4 w-4 bg-gray-600 dark:bg-gray-800 text-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
          ...
          <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
              <Button 
                ...
                size="sm" 
                className={cn(
                  "rounded-full px-3 py-1 h-[26px] text-xs font-medium border-dashed",
                  "flex items-center gap-1.5 bg-gray-100/50 dark:bg-gray-800/30",
