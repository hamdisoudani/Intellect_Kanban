...
/**
 * NextAuth configuration options for teacher app
 */
export const authConfig = {
  ...
  cookies: {
    sessionToken: {
      name: "teacher-next-auth.session-token",
      options: {
        httpOnly: true,
        sameSite: 'lax',
        path: '/',
    ...
    callbackUrl: {
      name: "teacher-next-auth.callback-url",
      options: {
        sameSite: 'lax',
        path: '/',
        secure: process.env.NODE_ENV === 'production',
    ...
    csrfToken: {
      name: "teacher-next-auth.csrf-token",
      options: {
        httpOnly: true,
        sameSite: 'lax',
        path: '/',
